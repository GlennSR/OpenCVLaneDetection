...
def draw_lines(image, lines):
    ...
    if lines is not None:
        ...
        if len(left_x1) and len(left_x2) and len(right_x1) and len(right_x2):
            ...
            # Draw the lines
            print(str(l_avg_x1) + ',' + str(l_avg_x2) + ';' + str(r_avg_x1) + ',' + str(r_avg_x2))
...
def process(img):
    ...
    region_of_interest_vertices = [(0, height), (0, 250), (width, 250), (width, height)]
